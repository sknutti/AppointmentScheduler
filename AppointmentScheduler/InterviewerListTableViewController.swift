//
//  InterviewerListTableViewController.swift
...
class InterviewerListTableViewController: UITableViewController {
    ...
    lazy var fetchedResultsController: NSFetchedResultsController = {
        ...
        fetchRequest.predicate = NSPredicate(format: "isInterviewer == %@", argumentArray: [1]);
...
extension InterviewerListTableViewController: NSFetchedResultsControllerDelegate {
...
extension InterviewerListTableViewController {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if (appointment.member?.memberName != record.memberName) {
            if (self.delegate != nil) {
                delegate?.addInterviewer(record)
